...
components.fontGothicA1 = {
    selector: 'html',
    styles: 'https://fonts.googleapis.com/css2?family=Gothic+A1:wght@300;400;500;600;800&display=swap'
};
...
components.textBanner = {
    ...
    styles: './components/text-banner/text-banner.css'
};
...
components.fullcalendar = {
    ...
    script: [
        './components/fullcalendar/core/main.min.js',
        './components/fullcalendar/daygrid/main.min.js',
        './components/fullcalendar/timegrid/main.min.js',
        './components/fullcalendar/interaction/main.min.js',
        './components/prompt/prompt.min.js'
    ],
    init: function(nodes) {
        nodes.forEach(function(node) {
            let calendar = new FullCalendar.Calendar(node, {
                ...
                editable: true,
                eventOverlap: false,
                events: parseJSON(node.getAttribute('data-fullcalendar-event')),
                eventRender: function(info) {
                    let
                        calendarScroller = node.querySelector('.fc-scroller'),
                    ...
                    let tooltip = new Tooltip({
                        trigger: info.el,
                        name: 'prompt',
                        content: '<ul class="prompt-list">' + info.el.querySelector('.fc-title').innerHTML + '</ul>',
                        position: 'top',
                        event: "click",
                        close: true
                    });

                    node.addEventListener('scroll', scrollHandler.bind(tooltip));
                    calendarScroller.addEventListener('scroll', scrollHandler.bind(tooltip));
                }
            });
...
components.owlCarousel = {
    ...
    styles: [
        './components/owl-carousel/owl.theme.css',
